...
<style>
  .xnml-logo {
    background: #3B5888 url(http://planbus.com/app/demo/demo_logo.png) no-repeat scroll 20px center;
    border-bottom: 2px solid #5872A1;
    height: 50px;
    position: relative;
  }
  ...
  .xnmls-tabs .current a {
    background: #5D74A2 none repeat scroll 0 0;
  }

  .xnmls-tabs a {
    background: #486598 none repeat scroll 0 0;
    color: #FFFFFF;
    display: block;
    padding: 4px 10px;
...
<div class="xnml-header">
  <div class="xnml-logo">
    <div class="xnmls-tabs">
      <ul>
        <li <?= $cur1; ?>><a title="开发应用相关知识" href="index.php">简单介绍</a></li>
...
$api_key  = '5bf2068654d345ac84de570c334b8673'; // 你的 api_key
$secret    = '6facc67315ba4fc684baf6e0e871a7df'; // 你的 secret
