					...
					?>
								...
								<?php } else { ?>
									<li>
										...
										<span class="time"><?= formatTime("Y-m-d", $mybook[$i]["dateline"], 1) ?></span>
										<h4><?= $mybook[$i]["subject"] ?></h4>
								...
								<li id="list_<?= $mybook[$i]["bkid"] ?>">
									...
									<span class="time"><?= formatTime("Y-m-d", $mybook[$i]["dateline"], 1) ?></span>
									<h4><?= $mybook[$i]["subject"] ?></h4>
									<?php $remain_cook_time = $mybook[$i]["dateline"] + 300 - $time_stamp;
									$hasEdit = $remain_cook_time > 0; ?>
									<?php if ($hasEdit) { ?>
